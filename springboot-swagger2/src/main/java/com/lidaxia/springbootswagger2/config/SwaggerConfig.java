package com.lidaxia.springbootswagger2.config;
...
public class SwaggerConfig {
    ...
    public Docket controllerApi() {
        //全局统一参数
        List<Parameter> globalOperationParametersList = new ArrayList<>(10);
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .contact(new Contact("lidaxia", "https://www.lidaxia.com/doc/", ""))
                        .version("版本号:1.0")
                        .build())
                ...
                .select()
                //API基础扫描路径
                .apis(RequestHandlerSelectors.basePackage("com.lidaxia.springbootswagger2.controller"))
